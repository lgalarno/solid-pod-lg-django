...
urlpatterns = [
    ...
    path('connect-session/', views.connect_oidc_session, name="connect_session"),
    ...
    path('refesh-token/', views.refresh_token, name="refresh-token"),
    path('session-refesh-token/', views.session_refresh_token, name="session-refresh-token"),
